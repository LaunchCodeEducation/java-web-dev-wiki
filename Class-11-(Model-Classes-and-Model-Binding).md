...
1. It may be tempting for students to associate models with data storage. In fact, we do use a model for temporary data storage in the example repo, ``coding-events``. Emphasize that this aspect will be refactored and models are not raw data in a proper mvc app.
...
## Small Group Thyme: Class 11 Studio (TA Notes)
